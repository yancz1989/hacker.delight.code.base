...
/* Variation 1: Use ntz to avoid division.  Eight ops. */
...
unsigned snoob1(unsigned x) {
   ...
   ripple = x + smallest;       //     xxx1 0000 0000
   ones = x ^ ripple;           //     0001 1111 0000
   ones = ones >> 2;            //     0000 0111 1100
   ones = ones >> ntz(x);       //     0000 0000 0111
   return ripple | ones;        //     xxx1 0000 0111
}

/* Variation 2: Use nlz to avoid division. Nine ops.
Caution: Does not work for x = 0x4000_0000 if the
machine has mod 32 shifts. */
...
/* Variation 3: Use pop to avoid division.  Nine ops.
Must have x != 0. */
